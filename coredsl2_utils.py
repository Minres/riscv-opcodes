from constants import arg_lut
from shared_utils import InstrDict


def map_variable(variable_name: str):
    # basically the arg_lut table, formated using ChatGPT
    variable_mapping = {
        "rd": "rd[4:0]",
        "rt": "rt",
        "rs1": "rs1[4:0]",
        ...
        "csr": "csr[11:0]",
        "imm12hi": "imm[11:5]",
        "bimm12hi": "imm[12:12] :: imm[10:5]",
        "imm12lo": "imm[4:0]",
        "bimm12lo": "imm[4:1] :: imm[11:11]",
        "shamtq": "shamtq",
        "shamtw": "shamtw",
        "shamtw4": "shamtw4",
        "shamtd": "shamtd",
...
def map_assembly(variable_name: str):
    variable_mapping = {
        "rd": "name(rd)",
        "rt": "rt",
        "rs1": "name(rs1)",
...
def make_coredsl2(instr_dict: InstrDict) -> None:
